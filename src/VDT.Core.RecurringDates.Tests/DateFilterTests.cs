...
public class DateFilterTests {
    ...
    public void Constructor_Removes_Time_From_Dates() {
        var filter = new DateFilter([new DateTime(2022, 1, 2, 11, 12, 30), new DateTime(2022, 1, 3, 12, 37, 30)]);

        Assert.Equal([new DateTime(2022, 1, 2), new DateTime(2022, 1, 3)], filter.Dates);
    }
